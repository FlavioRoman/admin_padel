...
const CreatePlayerForm = () => {
  // VALIDACIONES DEL FORMULARIO (PUEDE SER MAS ESTRICTO SI LO DESEAN)
  const initialValues = {
    nombre: "",
    apellido: "",
    sexo: "",
  ...
  return (
    <motion.div
      ...
      className="container-player-form"
    >
      <Formik
      ...
      {/* ELEMENTO DIV PARA IMPLEMENTAR LA IMAGEN (IMAGEN QUE ESTA A LA DERECHA) */}
